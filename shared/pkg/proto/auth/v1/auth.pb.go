...
type GetUserResponse struct {
	...
	// Email пользователя
	Email string `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	// Список каналов уведомлений пользователя
	NotificationMethods []*NotificationMethod `protobuf:"bytes,4,rep,name=notification_methods,json=notificationMethods,proto3" json:"notification_methods,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\aGetUser\x12\x17.auth.v1.GetUserRequest\x1a\x18.auth.v1.GetUserResponseB\x1cZ\x1a/pkg/proto/auth/v1;auth_v1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*NotificationMethod)(nil), // 1: auth.v1.NotificationMethod
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	1, // 0: auth.v1.RegisterRequest.notification_methods:type_name -> auth.v1.NotificationMethod
	1, // 1: auth.v1.GetUserResponse.notification_methods:type_name -> auth.v1.NotificationMethod
